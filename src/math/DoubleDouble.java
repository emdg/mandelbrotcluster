	...
	implements Serializable, Comparable, Cloneable
{
	 ...
	 */
	public static DoubleDouble ddValueOf(String str) 
	 ...
	 * @return the extended precision version of the value
	 */
	public static DoubleDouble ddValueOf(double x) { return new DoubleDouble(x); }
 ...
 */
	...
	{
		if (exp == 0.0)
			return ddValueOf(1.0);
		
	  DoubleDouble r = new DoubleDouble(this);
	  DoubleDouble s = ddValueOf(1.0);
	  int n = Math.abs(exp);
...
//	    	throw new IllegalStateException("Internal errror: found digit = " + digit);
	    ...
	    y = (y.subtract(DoubleDouble.ddValueOf(digit))
	    		.multiply(TEN));
	    if (rebiasBy10)
	    	y.selfAdd(TEN);
